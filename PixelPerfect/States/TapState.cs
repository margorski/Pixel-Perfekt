...
namespace PixelPerfect
{
    class TapState : GameState
    {
        ...
        public override void Draw(Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch, bool suspended, bool upsidedownBatch = false)
        {
            ...
            spriteBatch.Draw(Globals.textureDictionary["tap"], new Vector2(Config.SCREEN_WIDTH_SCALED / 2 - 12, Config.SCREEN_HEIGHT_SCALED / 2 - 10), new Rectangle(0, tapAnimation.currentFrame * 24, 24, 24), Color.White);
        }
